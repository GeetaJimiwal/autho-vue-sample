  ...
  <div>
    <header class="bg-white black-80 tc pt4 avenir">
      ...
      <nav class="bt bb tc mw7 center mt4 flex justify-between flex-wrap">
        ...
        <a class="f6 f5-l link bg-animate black-80 hover-bg-washed-red dib pv3 ph2 ph4-l"  href="">
          <router-link class="link black" to="/product">Products</router-link>
        </a>
        <a class="f6 f5-l link bg-animate black-80 hover-bg-light-yellow dib pv3 ph2 ph4-l">
          <router-link class="link black relative" to="/cart">Cart</router-link>
        </a>
        <!-- <a class="f6 f5-l link bg-animate black-80 hover-bg-light-pink dib pv3 ph2 ph4-l pointer">
          <span id="qsLoginBtn" @click.prevent="login"><i class="fas fa-sign-in-alt mr2"></i>Login</span>
        </a> -->
        <a class="f6 f5-l link bg-animate black-80 hover-bg-light-green dib pv3 ph2 ph4-l pointer">
          <router-link class="link black" to="/profile">Profile</router-link>
        </a>     
        <a class="f6 f5-l link bg-animate black-80 hover-bg-light-pink dib pv3 ph2 ph4-l pointer">
          <img class="br-100 w1 h1" alt=""> <span id="qsLogoutBtn" href="#"> Log out </span>
        </a>
      </nav>
    </header>
  </div>
